           ...
           <div className="content-div">
               <div className="type-div">
                   ...
                   <div className="type-name-div">
                       <h2 className="name">
                           Ուսումնական<br></br>Հաստատություն
                       </h2>
                   </div>
               </div>
               <input className='sign-up-inp' type="name" placeholder='Ուս․ հաստատության անվանումը' onChange={newName} name="fullName"  id='name-input'></input>
               <input className='sign-up-inp' type="name" placeholder='Ուս․ հաստատության տնօրենը'onChange={newHeadmaster} name="headmaster" ></input>
               <input className='sign-up-inp' type="tell" placeholder='Ուս․ հաստատության հեռախոսահամարը' onChange={newPhone} name="phone" ></input>
               <input className='sign-up-inp' type="email" placeholder='Ուս․ հաստատության էլ․ փոստը'onChange={newMail} name="email" ></input>
               <input className='sign-up-inp' type="adress" placeholder='Ուս․ հաստատության հասցեն'onChange={newAddress} name="address"></input>
               <select className="sign-up-inp" onChange={newType}>
                   <option value={0}>Ուս․ հաստատության տեսակը</option>
                   <option value={"Համալսարան"}>Համալսարան</option>
                   <option value={"Քոլեջ"}>Քոլեջ</option>
                   <option value={"Դպրոց"}>Դպրոց</option>
                   <option value={"Կրթահամալիր"}>Կրթահամալիր</option>
               </select>
               <select className="sign-up-inp" onChange={newStatus}>
                   <option value={0}>Ուս․ հաստատության կարգավիճակը</option>
                   <option value={"Պետական"}>Պետական</option>
                   <option value={"Ոչ պետական"}>Ոչ պետական</option>
                   <option value={"Միջազգային"}>Միջազգային</option>
               </select>
               <input className='sign-up-inp' placeholder='Ուս․ հաստատության նպատակը' name="purpose" maxLength={30} onChange={newPurpose}></input>

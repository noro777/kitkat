...
<div class="containrrrr">
    <div>
        ...
        <a href="{{ route('lecturer.register') }}" class="btn btn-primary">cteate</a>
    </div>

    <form action="{{ route('admin.lecturer.search') }}" method="POST" >
                    @csrf
              ...
              <table class="table table-image">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td class="w-25">
                        <img src="{{ asset('images/lecturer/'.$lecturer->image) }}" class="img-fluid img-thumbnail w-50" alt="Sheep">
                    </td>
                    <td>{{ $lecturer->name }}</td>

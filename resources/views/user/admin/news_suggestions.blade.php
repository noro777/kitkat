...
<div class="containrrrr">
    <div>
        ...
        <a href="{{ route('admin.NewsSuggestionCreate') }}" class="btn btn-primary">cteate</a>
    </div>

    <form action="{{ route('admin.news_suggestions.search') }}" method="POST" >
                    @csrf
              ...
              <table class="table table-image">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td>{{ $NewsSuggestion->name }}</td>
                    <td class="w-25">
                        <img src="{{ asset('images/news_suggestion/'.$NewsSuggestion->image) }}" class="img-fluid img-thumbnail w-50" alt="Sheep">
                    </td>

...
<div class="containrrrr">
    <div>
        ...
        <a href="{{ route('admin.freelance.create') }}" class="btn btn-primary">cteate</a>
    </div>

    <form action="{{ route('admin.freelance.search') }}" method="POST" >
                    @csrf
              ...
              <table class="table table-image">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    {{--  <td class="w-25">
                        <img src="{{ asset('images/student/'.$student->image) }}" class="img-fluid img-thumbnail w-50" alt="Sheep">
                    </td>  --}}

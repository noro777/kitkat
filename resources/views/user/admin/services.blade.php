...
<div class="containrrrr">
    <div>
        ...
        <a href="{{ route('admin.services.create') }}" class="btn btn-primary">cteate</a>
    </div>

    <form action="{{ route('admin.services.search') }}" method="POST" >
                    @csrf
              ...
              <table class="table table-image">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td>{{ $service->name }}</td>
                    <td class="w-25">
                        <img src="{{ asset('images/services/'.$service->image) }}" class="img-fluid img-thumbnail w-50" alt="Sheep">
                    </td>

...
<div class="containrrrr">
    <div>
        ...
        <a href="{{ route('admin.facultets.create') }}" class="btn btn-primary">cteate</a>
    </div>

    <form action="{{ route('admin.facultets.search') }}" method="POST" >
                    @csrf
              ...
              <table class="table table-image">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td>{{ $facultet->name }}</td>
                    <td class="w-25">
                        <img src="{{ asset('images/facultets/'.$facultet->image) }}" class="img-fluid img-thumbnail w-50" alt="Sheep">
                    </td>

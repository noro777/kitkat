...
<div class="containrrrr">
    <div>
        ...
        <a href="{{ route('admin.work.create') }}" class="btn btn-primary">cteate</a>
    </div>

    <form action="{{ route('admin.work.search') }}" method="POST" >
                    @csrf
              ...
              <table class="table table-image">
                ...
                <tbody>
                  ...
                  <tr>
                    <th scope="row">{{ $work->id }}</th>
                    {{--  <td class="w-25">
                        <img src="{{ asset('images/work/'.$work->image) }}" class="img-fluid img-thumbnail w-50" alt="Sheep">
                    </td>  --}}
                    <td>{{ $work->description }}</td>
                    <td>{{ $work->address }}</td>
                    <td>{{ $work->created_at }}</td>
